...
/**
 * This class implement a personalized Pearson Correlation Coeffient algorithm
 *
 * @author ccadete
 *
 */
public class PearsonCorrelationUserSimilarity implements UserSimilarity {
    ...
    public PearsonCorrelationUserSimilarity(DataModel dataModel) throws TasteException {
        this(dataModel, Weighting.UNWEIGHTED);
    }

    public PearsonCorrelationUserSimilarity(final DataModel dataModel, Weighting weighting)
